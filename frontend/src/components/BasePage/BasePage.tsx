...
export const BasePage = () => {
  ...
  const freeBooks:BookPreviewProps[] = [
    {id: 4, name: "Ember in the Ashes", author: "Sabaa Tahir", price: 0, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7gKCrgT8GE7H_zoBE2_qlQfUCBWBSMXK88LuSGpfWbv_v6fqZJJVjWy2EXjcoV7fQnwI&usqp=CAU" },
    {id: 5, name: "Torch Against the Night", author: "Sabaa Tahir", price: 0, image: "https://img.thriftbooks.com/api/images/i/m/54DC367FBA6E8444B3542650E7406DE5E5F654A6.jpg" },
    {id: 6, name: "A Reaper at the Gates", author: "Sabaa Tahir", price: 0, image: "https://images-na.ssl-images-amazon.com/images/I/81KqCnGkglL.jpg" },
    {id: 7, name: "Sky Beyond the Storm", author: "Sabaa Tahir", price: 0, image: "https://cdn.knihcentrum.cz/99385536_a-sky-beyond-the-storm-1.jpeg" },
    {id: 4, name: "Ember in the Ashes", author: "Sabaa Tahir", price: 0, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7gKCrgT8GE7H_zoBE2_qlQfUCBWBSMXK88LuSGpfWbv_v6fqZJJVjWy2EXjcoV7fQnwI&usqp=CAU" },
  ]
  

  const newlyAdded:BookPreviewProps[] = [
    {id: 8, name: "Odin's Child", author: "Siri Pettersen", price: 15, image: "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/6469/9781646900008.jpg" },
    {id: 9, name: "The Rot", author: "Siri Pettersen", price: 10, image: "https://image.ebooks.com/previews/210/210311/210311388/210311388.jpg" },
    {id: 10, name: "The Might", author: "Siri Pettersen", price: 20, image: "https://d28hgpri8am2if.cloudfront.net/book_images/onix/cvr9781646900022/the-might-9781646900022.jpg" },
    {id: 11, name: "Blood Song", author: "Anthony Ryan", price: 13, image: "https://i0.wp.com/anthonyryan.net/wp-content/uploads/2013/03/blood-song-us-cover.jpg?resize=250%2C378" },
    {id: 8, name: "Odin's Child", author: "Siri Pettersen", price: 15, image: "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/6469/9781646900008.jpg" },
  ]
    ...
    return (
      <div className="basepage-wrapper">
        ...
        <div className="books-wrapper">
          {bestsellers.slice(0, 2).map((b) => <BookPreview id={b.id} image={b.image} name={b.name} author={b.author} price={b.price} />)}
        </div>
        ...
        <div className="books-wrapper">
          {freeBooks.slice(0, 2).map((b) => <BookPreview id={b.id} image={b.image} name={b.name} author={b.author} price={b.price} />)}
        </div>
        ...
        <div className="books-wrapper">
          {newlyAdded.slice(0, 2).map((b) => <BookPreview {...b} />)}
        </div>
      </div>
    )
  } else {
